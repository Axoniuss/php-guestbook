 ...
 <title>Вход</title>
  ...
  <body>
    ...
    <form class="form-horizontal" action="" method="post" >
      ...
      <div class="form-group">
        <h2 class="col-sm-offset-4 col-sm-4">Логин</h2>
      </div>
      
      <div class="form-group">
        <label for="inputUsername" class="col-sm-4 control-label">Логин</label>
        <div class="col-sm-3">
          <input type="text" class="form-control" id="inputUsername" name="username" placeholder="Логин">
        </div>
      </div>
      <div class="form-group">
