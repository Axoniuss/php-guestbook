...
<body>
  ...
  <div class="jumbotron"
    style="background-image: url(img/bg.jpg); background-repeat: no-repeat;background-size:100% 100%;">
    <div class="container">
    ...
    <div class="row">
      ...
      <div class="comment-box col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="author-box">
          <!-- Аватар автора -->
          <div id="avatar">
            <img src="./img/avatar/<?php echo $author->getAvatar()."?r=".rand(1,999999); ?>" height="150px"
              width="150px" />
          </div>
        ...
        <div class="content-box">
          <!-- 留言时间 -->
          <div id="date">
            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Номер сообщения:
            <?php echo $comments[$i]['id']; ?>
            &nbsp;&nbsp;&nbsp;
            <span class="glyphicon glyphicon-time" aria-hidden="true"></span> Время отправки сообщения:
